...
const MainNavButton = () => {
    return (
        <main className='flex flex-col justify-center items-center'>
            <div className='relative w-[280px] h-[255px] bg-white bg-opacity-40 mt-2 rounded-xl'>
                <button className='absolute w-[120px] h-[120px] bg-slate-300 left-[5rem] 
                ...
                <button id="btn-left" className='pl-12 pr-12 absolute  bg-transparent rotate-90 bottom-[6rem] left-[-2.4rem] '>
                ...
                <button id="btn-right" className='pl-12 pr-12  absolute  bg-transparent -rotate-90 bottom-[6rem] left-[11.3rem]  '>
                    <BiDownArrow size={40} className=" hover:fill-purple-900 hover:drop-shadow-[0px_0px_10px_#2c1263]"/>
                </button>
