        ...
        <main>
            <div className='flex flex-row justify-center gap-8'>
                ...
                <div className='flex flex-col'>
                    <button className='w-12 h-10 bg-slate-300 grid place-content-center rounded-b-none'><HiPlus size={20} /></button>
                    <button className='w-12 h-8 bg-slate-300 grid place-content-center rounded-r-none rounded-l-none'><ImVolumeMute2  size={15}/></button>
